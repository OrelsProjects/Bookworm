...
export default function Home(): React.ReactNode {
            ...
            {allRecommendations.length > 0 &&
              allRecommendations
                ...
                .map((recommendationList) => {
                  ...
                  return (
                    <div
                      className="flex flex-row gap-4 cursor-pointer transition-all md:p-2.5 md:hover:bg-slate-400/40 rounded-xl"
  ...
  return (
    <div
      className={`h-full w-full flex flex-col relative justify-top items-start gap-10 pb-5 md:overflow-auto`}
    >
      <SearchBar
