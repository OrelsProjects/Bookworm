  ...
  return (
    <Tabs
      items={genres.slice(0, take).map((genre: string) => ({
        ...
        value: genre,
        className: cn(
          "h-5 py-3 md:h-8 border-2 font-bold leading-6 md:text-base bg-foreground text-background dark:bg-background dark:text-foreground dark:border-foreground dark:hover:bg-foreground dark:hover:text-background dark:hover:border-foreground",
          itemClassName
        ),
      }))}
