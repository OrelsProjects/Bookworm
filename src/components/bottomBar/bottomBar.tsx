...
const BottomBar = () => {
  ...
  return (
    <div className="w-full flex flex-row justify-center z-40 absolute">
      <div className="flex items-center justify-between gap-4 w-max bg-foreground rounded-xl absolute bottom-6 py-3 px-7">
